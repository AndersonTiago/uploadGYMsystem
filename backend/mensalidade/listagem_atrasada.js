$(document).ready(function(){
	...
	function atualizaTabela(){		
		$.ajax({
			...
			data: 'action=listaMensalidade_atrasada',
			cahce: false,
			success:function(e){
				...
				document.getElementById('tbl_mensalidade_atrasada').innerHMTL = montaTbl(pesquisa)
			}
		})		
	}
	...
	function montaTbl(tabela){
		// Apagando a tabela
		document.getElementById('tbl_mensalidade_atrasada').innerHTML = ""
		...
		// Fixando a tabela para visualização
	 	$('#tbl_mensalidade_atrasada').append(mountTabela)

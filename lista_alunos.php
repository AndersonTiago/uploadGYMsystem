            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="input-group mb-3 col-md-12">
                        ...
                        <input id="modal_nome_aluno" type="text" class="form-control" placeholder="Nome do usuário" aria-describedby="basic-addon1" >
                    </div>
                </div>
                <div class="row">
                    <div class="input-group mb-3 col-md-12">
                ...
                <div class="row">
                    <div class="input-group mb-3 col-md-12">
                        ...
                        <input id="modal_numero_aluno" type="number" class="form-control " placeholder="Número" aria-label="Username" aria-describedby="basic-addon1" >             
                    </div>
                </div>
